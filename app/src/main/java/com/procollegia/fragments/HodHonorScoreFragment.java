...
public class HodHonorScoreFragment extends Fragment {
    ...
    public HodHonorScoreFragment() {}

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_hod_honor_score, container, false);
                ...
                .addOnSuccessListener(qs -> {
                    ...
                    for (QueryDocumentSnapshot d : qs) {
                        ...
                        leaderboardList.add(new LeaderboardAdapter.StudentScore(
                                d.getId(),
                                d.getString("name"),
                                d.getString("department") != null ? d.getString("department") : "Dept",
    ...
    private void setupReasonSpinner() {
        String[] rs = {"HOD Special Commendation", "Dept. Sports Win", "Academic Excellence", "Conduct Violation", "Syllabus Default", "Other"};
    ...
    private void applyChanges() {
        ...
        int projectedScore = selectedScore + delta;
        if (projectedScore < 0 || projectedScore > 1500) {
        ...
        db.collection("users").document(selectedId).update(update)
                .addOnSuccessListener(v -> {
                    Toast.makeText(getContext(), "Academic Points Updated!", Toast.LENGTH_SHORT).show();
    ...
    private void logEvent(String si, long cp) {
        ...
        log.put("points", cp);
        log.put("reason", "HOD: " + spReason.getSelectedItem().toString());
